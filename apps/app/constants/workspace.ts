...
export const ONBOARDING_CARDS = {
  welcome: {
    imgURL: Welcome,
    step: "1/5",
    title: "Welcome to DraftIT",
    description: "DraftIT helps you plan your issues, cycles, and product modules to ship faster.",
  },
  issue: {
    imgURL: Issue,
    step: "2/5",
    ...
    description:
      "The issue is the building block of the DraftIT. Most concepts in DraftIT are either associated with issues and their properties.",
  },
  cycle: {
    imgURL: Cycle,
    step: "3/5",

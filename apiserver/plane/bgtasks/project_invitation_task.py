...
def project_invitation(email, project_id, token, current_site):
    try:
        ...
        from_email_string = f"Team draftit <team@mailer.plane.so>"

        subject = f"{project.created_by.first_name or project.created_by.email} invited you to join {project.name} on draftit"
